...
class YOLOv8Detector:
    ...
    def __init__(
        self, onnx_model_path: str, conf_threshold: float = 0.5, iou_threshold: float = 0.45, use_gpu: bool = 0
    ):
...
if __name__ == "__main__":
    ...
    detector = YOLOv8Detector(
        onnx_model_path=Onnx_model_path, conf_threshold=Conf_threshold, iou_threshold=Iou_threshold, use_gpu=Use_gpu
    )
